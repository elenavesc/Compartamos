      ...
      <div className="landing__header">
        ...
        <div className="landing__text">
          <p className="landing__subtitle">
            Si no te gusta la soledad,{" "}
            <img className="landing_image" src={image} alt="logo" />
          </p>
        </div>
        ...
        <div className="landing_p">
          <div className="landing_ph">
            ...
            <p className="landing_frase">
              "Mi soledad no tiene nada que ver con la presencia o ausencia de
              personas. Detesto quien me roba la soledad sin a cambio ofrecer
              verdadera compañía"
            </p>
